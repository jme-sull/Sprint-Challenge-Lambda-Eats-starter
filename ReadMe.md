...
useRouteMatch allows you to add nested routed to your applicatino so that you can change a single parameter in the URl without havign to change the whole thing. 


2. How would you explain form validation to someone who has never programmed before?

Form validation is what checks that the data you have entered into a form matches the data needed to submit the form. 


3. In 1-2 sentences, define end to end testing.

End to End testing focuses on UI and how a user might interact with an app. It ensures that user can accomplish any need action without roadblocks or bugs. 
